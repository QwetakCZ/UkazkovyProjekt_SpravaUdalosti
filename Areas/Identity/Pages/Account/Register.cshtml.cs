...
namespace SpravaUdalosti.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// <summary>
        /// Pridaní role Admin prvnímu uživateli
        /// </summary>
        /// <param name="user"></param>
        /// <returns></returns>
        public async Task<bool> PridatRole(IdentityUser user)
        {
            int pocetUzivatelu = await _userManager.Users.CountAsync();
            if (pocetUzivatelu > 0)
            {
                return false;
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                bool jePrvniUzivatel = await PridatRole(user); //Pridani role Admin prvnimu uzivateli
